...
CONF_SUPPORTED_TYPE = {
    ...
    "TARGET_WATER_TEMPERATURE": {
        ...
        CONF_CLASS: TRUMA_SENSOR_TYPE_dummy_ns.AIRCON_CURRENT_TEMPERATURE,
        CONF_UNIT_OF_MEASUREMENT: UNIT_CELSIUS,
        CONF_ICON: ICON_THERMOMETER,
        CONF_ACCURACY_DECIMALS: 1,
        CONF_DEVICE_CLASS: DEVICE_CLASS_TEMPERATURE,
    ...
    "AIRCON_TARGET_TEMPERATURE": {
        CONF_CLASS: TRUMA_SENSOR_TYPE_dummy_ns.AIRCON_TARGET_TEMPERATURE,
        CONF_UNIT_OF_MEASUREMENT: UNIT_CELSIUS,
        CONF_ICON: ICON_THERMOMETER,
        CONF_ACCURACY_DECIMALS: 0,
        CONF_DEVICE_CLASS: DEVICE_CLASS_TEMPERATURE,
    ...
    "CONFIG_TEMP_OFFSET": {
        CONF_CLASS: TRUMA_SENSOR_TYPE_dummy_ns.CONFIG_TEMP_OFFSET,
        CONF_UNIT_OF_MEASUREMENT: UNIT_CELSIUS,
        CONF_ICON: ICON_THERMOMETER,
        CONF_ACCURACY_DECIMALS: 1,
        CONF_DEVICE_CLASS: DEVICE_CLASS_TEMPERATURE,
